    ...
    <Screen style={tailwind`flex-1 justify-center`}>
      <View style={tailwind`px-4 py-4 rounded-2xl items-center`}>
        ...
        <View style={tailwind`w-64 mt-4`}>
          ...
          <TouchableOpacity
            style={tailwind`bg-blue-500 p-4 rounded items-center`}
            onPress={LoginUser}
          >
        ...
        <Text
          style={tailwind`mt-4 text-center text-black`}
          onPress={() => navigation.navigate("Signup")}
        >
          Não é um membro? <Text style={tailwind`font-bold`}>Inscrever-se</Text>
        </Text>
      </View>
    </Screen>
  );
