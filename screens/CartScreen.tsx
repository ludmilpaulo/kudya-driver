...
import { View, StyleSheet, Text, Modal, FlatList, ScrollView, Image } from 'react-native';
...
const pickOrder = async() => {
    ...
    let response = await fetch('https://www.sunshinedeliver.com/api/driver/order/latest/', {
          method: 'POST',
          headers: {
    ...
    return (
        <Screen style={tailwind`flex-1 bg-white`}>
            ...
            <View style={tailwind`flex-1`}>
               ...
               <CartItems resData={restaurantData}  client={customerData} order={orderData} data={data} />
